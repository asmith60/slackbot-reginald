...
module.exports = {
    ...
    devToken: process.env.DEV_TOKEN || null,
    ...
    getArns: function(stage) {
        var arnString = this.getArnString(stage);
        return {
    ...
    getArnString: function(stage) {
      return "arn:aws:lambda:" + this.awsRegion + ":" + this.awsAccountId + ":" + "function:" + this.botName + "-" + stage + "-";
    }
};
